  ...
  return (
    <>
      <div className="col-lg-5 col-md-10">
        <div class="block-style-six pe-xxl-5 aos-init aos-animate" data-aos="fade-right">
          <div class="title-style-ten">
            <div className="sc-title">Why support this</div>
            <h2 className="main-title font-recoleta fw-normal tx-dark">
            People and businesses are backing Leccy
            </h2>
          </div>
          {/* /.title-style-ten */}

          <p className="fs-20 mt-15 mb-45">
          We’re all fed-up with terrible customer service and sky-high bills from the big energy companies.<br/> I’m bringing people and businesses together to create a better alternative
          </p>
      ...
      <div className="col-lg-7 col-md-9 m-auto">
        <div class="illustration-holder md-mt-60 position-relative">
          <img
            src="/images/media/img_49.png"
            alt="media"
            className="lazy-img main-img ms-auto"
          />
          <div class="card-style d-flex flex-column justify-content-center align-items-center">
